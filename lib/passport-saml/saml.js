...
// E.g., the Subject is part of the AuthenticationStatement and not available on the Asserton root
// Some other proprty accesses are also fixed
//
//*************************
...
// Repleacement line
//    var authnStatement = assertion.AuthenticationStatement;
    var authnStatement = assertion.AuthenticationStatement;
    if (authnStatement && authnStatement.length > 0) {
...
// Replacement
    var subject = (authnStatement && authnStatement.length > 0) ? authnStatement[0].Subject : null;
//END EDIT
...
// Replacement line
//            profile[attribute.$.AttributeName] = attrValueMapper(value[0]);
            profile[attribute.$.AttributeName] = attrValueMapper(value[0]);
          } else {
// COREORIENT EDIT
// Original line
...
// Replacement line
//            profile[attribute.$.AttributeName] = value.map(attrValueMapper);
            profile[attribute.$.AttributeName] = value.map(attrValueMapper);
          }
        });
      }
